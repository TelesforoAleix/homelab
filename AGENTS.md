...
- Keep changes scoped to the current phase unless a cross-phase change is explicitly approved.
...
Use `docs/templates/phase-handover-template.md` and the Definition of Done in `PROJECT.md` before declaring a phase complete.
